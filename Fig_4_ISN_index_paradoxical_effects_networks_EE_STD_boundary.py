...
# plt.plot(boundary_value_ISN[1, :], linewidth=plot_line_width)
# plt.plot(boundary_value_ISN[2, :], linewidth=plot_line_width)
#
# plt.plot(boundary_value_pd[0, :], color=pal[0], linestyle='dashed', linewidth=plot_line_width)
# plt.plot(boundary_value_pd[1, :], color=pal[1], linestyle='dashed', linewidth=plot_line_width)
# plt.plot(boundary_value_pd[2, :], color=pal[2], linestyle='dashed', linewidth=plot_line_width)
#
...
# plt.savefig('paper_figures/png/Fig_2_ISN_index_paradoxical_effect_linear_networks_EE_STD_boundary.png')
# plt.savefig('paper_figures/pdf/Fig_2_ISN_index_paradoxical_effect_linear_networks_EE_STD_boundary.pdf')
...
plt.xlabel(r'$r_E$', fontsize=font_size_1, **hfont)
plt.ylabel(r'$J_{EE}$', fontsize=font_size_1, **hfont)
plt.legend([r'$u_d$: 0.2', r'$u_d$: 1.0'], prop={"family": "Arial", 'size': font_size_1}, loc='best')
plt.savefig('paper_figures/png/Fig_4_ISN_index_paradoxical_effect_supralinear_networks_EE_STD_boundary.png')
plt.savefig('paper_figures/pdf/Fig_4_ISN_index_paradoxical_effect_supralinear_networks_EE_STD_boundary.pdf')
...
# plt.savefig('paper_figures/png/Fig_4_ISN_index_paradoxical_effect_sublinear_networks_EE_STD_boundary.png')
# plt.savefig('paper_figures/pdf/Fig_4_ISN_index_paradoxical_effect_sublinear_networks_EE_STD_boundary.pdf')
...
for g_e in l_g_e:
    ...
    plt.savefig('paper_figures/png/Fig_S1_Supralinear_network_EE_STD_frozen_inhibition_examples_g_e_' + str(g_e) + '.png')
    plt.savefig('paper_figures/pdf/Fig_S1_Supralinear_network_EE_STD_frozen_inhibition_examples_g_e_' + str(g_e) + '.pdf')

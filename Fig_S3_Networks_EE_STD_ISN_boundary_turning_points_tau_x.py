...
plt.savefig('paper_figures/png/Fig_S5_Supralinear_networks_EE_STD_ISN_boundary_turning_point_tau_x.png')
plt.savefig('paper_figures/pdf/Fig_S5_Supralinear_networks_EE_STD_ISN_boundary_turning_point_tau_x.pdf')

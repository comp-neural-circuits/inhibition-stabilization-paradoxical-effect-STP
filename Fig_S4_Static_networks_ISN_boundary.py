...
if b_zoomin:
    plt.savefig('paper_figures/png/Fig_S3_Linear_networks_EI_IE_II_STP_ISN_boundary_zoomin.png')
    plt.savefig('paper_figures/pdf/Fig_S3_Linear_networks_EI_IE_II_STP_ISN_boundary_zoomin.pdf')
else:
    plt.savefig('paper_figures/png/Fig_S3_Linear_networks_EI_IE_II_STP_ISN_boundary.png')
    plt.savefig('paper_figures/pdf/Fig_S3_Linear_networks_EI_IE_II_STP_ISN_boundary.pdf')
...
plt.ylabel(r'$J_{EE}$', fontsize=font_size_1, **hfont)
if b_zoomin:
    plt.savefig('paper_figures/png/Fig_S3_Supralinear_networks_EI_IE_II_STP_ISN_boundary_zoomin.png')
    plt.savefig('paper_figures/pdf/Fig_S3_Supralinear_networks_EI_IE_II_STP_ISN_boundary_zoomin.pdf')
else:
    plt.savefig('paper_figures/png/Fig_S3_Supralinear_networks_EI_IE_II_STP_ISN_boundary.png')
    plt.savefig('paper_figures/pdf/Fig_S3_Supralinear_networks_EI_IE_II_STP_ISN_boundary.pdf')
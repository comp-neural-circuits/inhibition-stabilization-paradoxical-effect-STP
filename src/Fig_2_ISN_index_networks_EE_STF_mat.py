...
plt.savefig('paper_figures/png/Fig_1_ISN_index_linear_networks_EE_STF_mat.png')
...
cbar = ax.collections[0].colorbar
cbar.set_ticks([-20, -10, 0, 10, 20])
plt.savefig('paper_figures/png/Fig_1_ISN_index_linear_networks_EE_STF_mat_zoomin.png')
...
cbar = ax.collections[0].colorbar
cbar.set_ticks([-20, -10, 0, 10, 20])
plt.savefig('paper_figures/png/Fig_1_ISN_index_supralinear_networks_EE_STF_mat.png')
...
cbar = ax.collections[0].colorbar
cbar.set_ticks([-20, -10, 0, 10, 20])
plt.savefig('paper_figures/png/Fig_1_ISN_index_supralinear_networks_EE_STF_mat_zoomin.png')
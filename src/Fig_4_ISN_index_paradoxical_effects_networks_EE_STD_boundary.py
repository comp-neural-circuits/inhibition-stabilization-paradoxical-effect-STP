...
plt.ylabel(r'$J_{EE}$', fontsize=font_size_1, **hfont)
plt.legend([r'$u_d$: 0.2', r'$u_d$: 0.6', r'$u_d$: 1.0'], prop={"family": "Arial", 'size': font_size_1}, loc='best')
plt.savefig('paper_figures/png/Fig_2_ISN_index_paradoxical_effect_supralinear_networks_EE_STD_boundary.png')
plt.savefig('paper_figures/pdf/Fig_2_ISN_index_paradoxical_effect_supralinear_networks_EE_STD_boundary.pdf')